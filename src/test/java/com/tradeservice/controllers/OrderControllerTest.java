...
import static com.tradeservice.util.TestConstants.ORDERS_ARRAY_JSON;
import static com.tradeservice.util.TestConstants.ORDER_JSON;
import static com.tradeservice.util.TestConstants.ORDER_TO_UPDATE;
import static com.tradeservice.util.TestConstants.ORDER_UPDATED_JSON;
...
class OrderControllerTest {
  ...
  void testUpdateOrder_fail_not_found() throws Exception {
    when(orderService.update(ORDER_TO_UPDATE, NOT_EXIST_ID)).thenThrow(OrderNotFoundException.class);
